...
class EmpolyerStatusChangeEmail extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
		...
		->greeting(' ')
		->subject('Harrier Candidates Employer credentials')
        ->line('You have now been granted access to Harrier Candidates.')
        ->line('Password : '.$this->guest->password )
        ->line("Don’t forget to create your own password within the platform. You will also want to update your Company profile with Office Locations and options for Working Arrangements (e.g. Full time Office, Full time Remote, Part time Hybrid) so that these options can be chosen when creating a New Job.")
